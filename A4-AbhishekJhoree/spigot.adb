...
-- spigot procedure
-- performs the main execution of the code and writes to the file
-- Also displays the execution time of the algorithm to the user
procedure spigot is

    -- Helper function to get the file information from the user
    -- @param filename The filename of the file to be created/overwritten
    -- @return void 
